-- Migration 0015: Do not derive negative filing intervals from source anomalies.
-- Some official filings contain a transaction date after the filing date. Keep
-- both source dates visible, but make the derived interval unavailable instead
-- of presenting an impossible negative delay as a measured fact.
